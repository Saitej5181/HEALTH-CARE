...
try:
    ...
    st.error("Diabetes model file not found. Please ensure 'Models/diabetes_model.sav' exists.")
try:
    models['heart_disease'] = pickle.load(open('Models/heart_disease_model.sav', 'rb'))
except FileNotFoundError:
    st.error("Heart disease model file not found. Please ensure 'Models/heart_disease_model.sav' exists.")
try:
    models['parkinsons'] = pickle.load(open('Models/parkinsons_model.sav', 'rb'))
except FileNotFoundError:
    st.error("Parkinson's model file not found. Please ensure 'Models/parkinsons_model.sav' exists.")
try:
    models['lung_cancer'] = pickle.load(open('Models/lungs_disease_model.sav', 'rb'))
except FileNotFoundError:
    st.error("Lung cancer model file not found. Please ensure 'Models/lungs_disease_model.sav' exists.")
try:
    models['thyroid'] = pickle.load(open('Models/Thyroid_model.sav', 'rb'))
except FileNotFoundError:
    st.error("Thyroid model file not found. Please ensure 'Models/Thyroid_model.sav' exists.")
